...
public abstract class TypeComponentImpl extends jdwp.oracle.MirrorImpl
    implements TypeComponent
{
    ...
    protected final jdwp.oracle.ReferenceTypeImpl declaringType;
    private final int modifiers;

    TypeComponentImpl(VirtualMachine vm, jdwp.oracle.ReferenceTypeImpl declaringType,
